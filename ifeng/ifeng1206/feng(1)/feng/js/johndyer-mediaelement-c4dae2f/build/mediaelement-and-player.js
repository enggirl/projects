...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
            $(".mejs-controls").css({"position":"relative",    "top": "156em", "bottom":""});
			var t = this;
        ...
        diyFullScreen:function(){
            //$(".modplayer").css({left:"0px",marginLeft:"-170px;});
            var t = this;
            normalHeight = t.container.height();
            normalWidth = t.container.width();
            ...
            if (t.media.pluginType === 'native') {
                ...
                t.media.setVideoSize(_w, normalHeight);
            }
		...
		exitFullScreen: function() {
            $(".mejs-controls").css({"position":"absolute",    "top": "", "bottom":"0em"});
			var t = this;
